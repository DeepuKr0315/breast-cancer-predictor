...
def add_predictions(input_data):
  ...
  # Get probabilities and convert them to percentage format
  prob_benign = model.predict_proba(input_array_scaled)[0][0] * 100
  prob_malicious = model.predict_proba(input_array_scaled)[0][1] * 100

  # Round the probabilities for better readability
  prob_benign = round(prob_benign, 2)
  prob_malicious = round(prob_malicious, 2)
  ...
  st.write(f"**Probability of being benign:** {prob_benign}%")
  st.write(f"**Probability of being malicious:** {prob_malicious}%")
...
def main():
    ...
    with st.container():
        ...
        st.write("""
            ...
            You can connect your lab inputs or manually adjust measurements using the sliders in the sidebar.
        """)
